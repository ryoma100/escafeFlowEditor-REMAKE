...
import { ActivityNode, CommentNode, DateTime, XpdlId } from "@/data-source/data-type";
...
const initProjectData = dataFactory.createProject("0001-01-01T00:00:00.000Z" as DateTime);
...
const oneProcessData = (function () {
  const project = dataFactory.createProject("0001-01-01T00:00:00.000Z" as DateTime);
  ...
  application1.xpdlId = "app1" as XpdlId;
  ...
  application2.xpdlId = "app2" as XpdlId;
...
const twoProcessData = dataFactory.createProject("0001-01-01T00:00:00.000Z" as DateTime);
twoProcessData.processes.push(
  dataFactory.createProcess(twoProcessData.processes, "9999-01-01T00:00:00.000Z" as DateTime),
);
